"""Pinned fp16 Metal source for bounded case-14 causal attention.
...
BLOCK_M=32, BLOCK_N=64, causal=True, out_dtype="fp16", and the kernel name
`causal_flash_attention_fp16_hd64`. The retained upstream licence is in
`solution/third_party/triton-msl-LICENSE`.
"""


CAUSAL_FLASH_ATTENTION_FP16_HD64 = r"""
#include <metal_stdlib>
#include <metal_simdgroup_matrix>
using namespace metal;

// simdgroup-MMA FlashAttention-2 (half in/out, fp32 compute, causal).
// Loop-split: branchless full-block fast loop + separate staged/masked tail block.
kernel void causal_flash_attention_fp16_hd64(
